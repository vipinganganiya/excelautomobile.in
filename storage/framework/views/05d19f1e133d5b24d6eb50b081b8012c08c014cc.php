...
<script type="text/javascript">
  ...
  var name = $(this).attr('name');
    $.ajax({
      url: '<?php echo e(sc_route('admin_config.update')); ?>',
      type: 'POST',
      dataType: 'JSON',
      data: {
...
(function( $ ){
      ...
      $.fn.filemanager = function(type, options) {
        ...
        this.on('click', function(e) {
          ...
          var route_prefix = (options && options.prefix) ? options.prefix : '<?php echo e(sc_route('admin.home').'/'.config('lfm.url_prefix')); ?>';
          var target_input = $('#' + $(this).data('input'));
          var target_preview = $('#' + $(this).data('preview'));
          window.open(route_prefix + '?type=' + type, '<?php echo e(trans('admin.file_manager')); ?>', 'width=900,height=600');
...
<script>
    ...
    $('.select2').select2();
</script><?php /**PATH /var/www/automobile.in/vendor/s-cart/core/src/Admin/Views/component/script.blade.php ENDPATH**/ ?>