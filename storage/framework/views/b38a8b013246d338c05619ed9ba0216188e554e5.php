            ...
            <div class="invoice p-3 mb-3">
                ...
                <div class="row invoice-info">
                    ...
                    <div class="col-sm-4 invoice-col">
                        ...
                        <b>Order Status:</b> <span class="badge"><?php echo e($statusOrder[$order->status]); ?></span><br>
                    </div>
                    <!-- /.col -->
                </div>
                <!-- /.row -->
                        ...
                        <table class="table table-bordered text-center">
                          ...
                          <tbody>
                            <?php $__currentLoopData = $order->details; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <td><input type="number" disabled class="add_total form-control" value="0"></td><td><input  type="number" min="0" class="add_tax form-control" name="add_tax[]" value="0"></td>
		                            ...
		                            <?php endif; ?>
		                             ...
		                             <?php if($element['code'] =='tax'): ?>
			                            <tr>
		                                    ...
		                                    <td class="text-right data-<?php echo e($element['code']); ?>"><?php echo e($element['value']); ?>%</td>
		                                </tr>
...
<?php echo $__env->make($templatePathAdmin.'layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/automobile.in/vendor/s-cart/core/src/Admin/Views/screen/order_edit.blade.php ENDPATH**/ ?>